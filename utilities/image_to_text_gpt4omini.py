...
def image_to_text_from_url(image_url, max_tokens = 300):
...
def image_to_text_from_base64(image_base64, max_tokens = 300):
...
if __name__ == "__main__":
    ...
    local_image_path = "utilities/util_storage/screenshot_2024-07-26_at_11.01.32___am.png"  # Replace with your local image path
    image_base64 = image_to_base64(local_image_path)
    print("\nExtracted text from Base64:")
    max_tokens = 400
    extracted_text = image_to_text_from_base64(image_base64, max_tokens)
    print(extracted_text)
    output_file_path = "utilities/util_storage/extracted_text.txt"
